    ...
    <div className="flex h-full flex-col bg-[#050a0f] text-white p-6 font-sans overflow-hidden relative" dir="ltr">
      ...
      <div className="flex items-center justify-between mb-6 relative z-10">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 bg-[#05140a] border border-green-500/30 rounded-lg flex items-center justify-center shadow-[0_0_15px_rgba(34,197,94,0.2)]">
            <Activity className="h-5 w-5 text-green-400" />
          </div>
          <div className="flex flex-col">
            <h1 className="text-xl font-bold text-white tracking-wide">System Diagnostics</h1>
            <span dir="rtl" className="font-arabic text-xs text-green-400/80">تشخيصات ومراقبة النظام</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1 min-h-0 relative z-10">
        ...
        {/* Top: Gauges */}
        <GlassCard className="col-span-12 p-6 bg-[#0a1118]/90 border-green-500/20 flex justify-around items-center" glowColor="rgba(34, 197, 94, 0.05)">
        ...
        <GlassCard className="col-span-12 lg:col-span-4 flex flex-col bg-[#0a1118]/90 border-yellow-500/20 overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-3">
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3">
              <h4 className="text-xs font-bold text-yellow-400 mb-1">High Memory Usage Detected</h4>
              <p className="text-[10px] text-white/70">Vector DB engine is consuming more memory than usual. Consider scaling.</p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-3">
              <h4 className="text-xs font-bold text-white/70 mb-1">Update Available</h4>
              <p className="text-[10px] text-white/50">Nexus Core v1.0.5 is ready to install.</p>
            </div>
          </div>
        </GlassCard>

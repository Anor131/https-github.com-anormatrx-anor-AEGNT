...
export default function Dashboard({ setActiveModule }: DashboardProps) {
  ...
  return (
    <div className="grid h-full grid-cols-12 gap-6 overflow-y-auto no-scrollbar pb-6">
      ...
      <div className="col-span-12 lg:col-span-8 flex flex-col gap-6">
        <GlassCard className="flex-1 relative overflow-hidden p-8" glowColor="rgba(139, 92, 246, 0.1)">
          ...
          <div className="relative z-10 flex flex-col h-full">
            <div className="flex justify-between items-start mb-8">
              <div>
                <h3 className="text-2xl font-bold tracking-tighter text-white neon-glow">المركز الـ 16: لوحة التحكم الرئيسية</h3>
              ...
              {isLaunching ? (
                ...
                <div className="flex gap-4">
                  <Button 
                    ...
                    className="flex-1 bg-cyan-500 hover:bg-cyan-400 text-black font-bold h-14 rounded-xl shadow-[0_0_20px_rgba(6,182,212,0.3)]"
                  >
                    <Play className="mr-2 h-5 w-5" /> تشغيل منصة الانطلاق | LAUNCH SYSTEM
                  </Button>
                  <Button 
                    variant="outline"
                    onClick={fetchDiagnostics}
                    className="w-14 h-14 rounded-xl border-white/10 hover:bg-white/5"
                  >

...
export default function FxSetup() {
  ...
  return (
    <div className="flex h-full flex-col bg-[#0f111a] text-white p-6 font-sans overflow-hidden relative" dir="ltr">
      {/* Background Gradient */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0 relative z-10 max-w-5xl mx-auto w-full overflow-y-auto custom-scrollbar pb-4">
        
        {/* Left Column */}
        <div className="flex flex-col gap-6">
          
          {/* Theme Controller */}
          <GlassCard className="p-6 bg-[#1a1d27]/80 border-cyan-500/20" glowColor="rgba(0, 255, 255, 0.05)">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-sm font-bold text-white flex items-center gap-2">Theme Controller <span className="text-white/30">|</span> <span dir="rtl" className="font-arabic">متحكم السمة</span></h3>
            </div>
            ...
            <div className="flex justify-center gap-8 mb-8">
              ...
              <div className="flex flex-col items-center gap-2 cursor-pointer" onClick={() => setTheme("Cyan")}>
                <div className={`w-20 h-20 rounded-full border-4 ${theme === 'Cyan' ? 'border-cyan-400' : 'border-[#2a2d37]'} flex items-center justify-center relative`}>
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cyan-300 to-cyan-700 shadow-[0_0_20px_rgba(0,255,255,0.5)]"></div>
                  {theme === 'Cyan' && <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-white rounded-full border-2 border-cyan-400"></div>}
                </div>
              ...
              <div className="flex flex-col items-center gap-2 cursor-pointer" onClick={() => setTheme("Magenta")}>
                <div className={`w-20 h-20 rounded-full border-4 ${theme === 'Magenta' ? 'border-fuchsia-400' : 'border-[#2a2d37]'} flex items-center justify-center relative`}>
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-fuchsia-300 to-fuchsia-700 shadow-[0_0_20px_rgba(217,70,239,0.5)]"></div>
                  {theme === 'Magenta' && <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-white rounded-full border-2 border-fuchsia-400"></div>}
                </div>
              ...
              <div className="flex flex-col items-center gap-2 cursor-pointer" onClick={() => setTheme("Gold")}>
                <div className={`w-20 h-20 rounded-full border-4 ${theme === 'Gold' ? 'border-yellow-400' : 'border-[#2a2d37]'} flex items-center justify-center relative`}>
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-yellow-300 to-yellow-700 shadow-[0_0_20px_rgba(250,204,21,0.5)]"></div>
                  {theme === 'Gold' && <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-white rounded-full border-2 border-yellow-400"></div>}
                </div>

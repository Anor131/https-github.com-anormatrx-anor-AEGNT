...
export default function SystemConfig() {
  ...
  return (
    <div className="flex h-full flex-col bg-[#0f172a] text-white p-6 font-sans overflow-hidden relative" dir="ltr">
      ...
      <div className="flex flex-col items-center justify-center mb-8 relative z-10 text-center">
        <h1 className="text-2xl font-bold text-white tracking-wide mb-2 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 flex-1 min-h-0 relative z-10 max-w-5xl mx-auto w-full overflow-y-auto custom-scrollbar pb-4">
        ...
        <div className="flex flex-col gap-6">
          ...
          <GlassCard className="p-6 bg-[#1e293b]/80 border-cyan-500/20" glowColor="rgba(0, 255, 255, 0.05)">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-sm font-bold text-white flex items-center gap-2">Cloud & Version Control <span className="text-white/30">|</span> <span dir="rtl" className="font-arabic">التحكم في الإصدار والسحابة</span></h3>
            </div>
            
            <div className="space-y-6">
              <div className="flex items-center justify-between bg-[#0f172a] p-4 rounded-lg border border-white/5">
                <div 
              ...
              <div className="flex items-center justify-between bg-[#0f172a] p-4 rounded-lg border border-white/5">
                <button className="flex items-center gap-2 bg-cyan-600 hover:bg-cyan-500 text-white px-4 py-2 rounded-lg text-sm transition-colors">
        ...
        <div className="flex flex-col gap-6">
          ...
          <GlassCard className="p-6 bg-[#1e293b]/80 border-cyan-500/20" glowColor="rgba(0, 255, 255, 0.05)">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-sm font-bold text-white flex items-center gap-2">Remote Servers <span className="text-white/30">|</span> <span dir="rtl" className="font-arabic">الخوادم عن بعد</span></h3>
            </div>
          ...
          <GlassCard className="p-6 bg-[#1e293b]/80 border-cyan-500/20 flex-1 flex flex-col" glowColor="rgba(0, 255, 255, 0.05)">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6 flex-1">
              <div className="bg-[#0f172a] rounded-lg border border-white/5 p-4 flex flex-col items-center justify-center gap-2">
                <span className="text-2xl font-bold text-cyan-400">1245</span>
                <span dir="rtl" className="font-arabic text-xs text-white/70 text-center">الإجراءات المخزنة: 1245<br/><span className="font-sans text-[10px]">Stored Actions: 1245</span></span>
                <Database className="h-6 w-6 text-cyan-400/50 mt-2" />
              </div>
              <div className="bg-[#0f172a] rounded-lg border border-white/5 p-4 flex flex-col items-center justify-center gap-2">
                <span className="text-2xl font-bold text-white">89</span>
                <span dir="rtl" className="font-arabic text-xs text-white/70 text-center">التفضيلات المحفوظة: 89<br/><span className="font-sans text-[10px]">Saved Preferences: 89</span></span>
                <Settings className="h-6 w-6 text-white/50 mt-2" />
              </div>
            </div>

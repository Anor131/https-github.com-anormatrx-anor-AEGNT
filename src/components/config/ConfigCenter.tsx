...
export default function ConfigCenter() {
  ...
  return (
    <div className="flex h-full flex-col gap-6 overflow-y-auto no-scrollbar pb-6">
      <div className="flex items-center justify-between">
        <h3 className="text-2xl font-bold tracking-tighter neon-glow">مركز التكوين النهائي</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        {configSections.map((section, idx) => (
          <GlassCard key={idx} className="p-6 flex flex-col gap-4" glowColor="rgba(0, 255, 255, 0.05)">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <GlassCard className="p-6" glowColor="rgba(139, 92, 246, 0.1)">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h4 className="font-bold tracking-tight">تسريع الأجهزة</h4>
          </div>
        ...
        <GlassCard className="p-6" glowColor="rgba(0, 255, 255, 0.1)">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h4 className="font-bold tracking-tight">تحسين الذاكرة</h4>
          </div>
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
      ...
      <div className="mt-auto flex justify-center">
        <Button className="bg-cyan-500 text-black hover:bg-cyan-400 px-12 py-6 text-lg font-bold tracking-widest shadow-[0_0_20px_rgba(0,255,255,0.4)]">
